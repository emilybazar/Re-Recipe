...
var RecipeContents = /** @class */ (function () {
    ...
    RecipeContents.findByRecipeID = function (recipe_ID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, RecipeContentsModel.find({ recipe_ID: recipe_ID }).exec()];
            });
        });
    };
    RecipeContents.findByUserID = function (user_ID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, RecipeContentsModel.find({ user_ID: user_ID }).exec()];
            });
        });
    };
